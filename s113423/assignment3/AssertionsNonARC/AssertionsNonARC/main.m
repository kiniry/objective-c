...
int main(int argc, char* argv[]) {
  ...
  NoblePerson *john = [[NoblePerson alloc] initWithName:@"John" sex:SexMale age:34 children:nil assets:[NSNumber numberWithDouble:40000.0] butler:nil];
  NoblePerson *kate = [[NoblePerson alloc] initWithName:@"Kate" sex:SexFemale age:27 children:nil assets:[NSNumber numberWithDouble:20000.0] butler:nil];
  ...
  kate = [[NoblePerson alloc] initWithName:@"Kate" sex:SexFemale age:27 children:nil assets:[NSNumber numberWithDouble:20000.0] butler:bert];
  ...
  NSSet* children = [NSSet setWithObjects:john, citizenB, nil];
  NoblePerson *curt = [[NoblePerson alloc] initWithName:@"Curt" sex:SexMale age:59 children:children assets:[NSNumber numberWithDouble:120000.0] butler:joe];
  ...
  NoblePerson *stan = [[NoblePerson alloc] initWithName:@"Stan" sex:SexMale age:47 children:[NSSet setWithObject:kate] assets:[NSNumber numberWithDouble:5000.0] butler:nil];
