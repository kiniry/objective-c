...
@property (readwrite, retain) NSNumber* assets;
@property (readwrite, retain) Citizen* butler;
@property (readwrite, retain) NoblePerson* spouse;
...
- (void)marry:(Citizen*)sweetheart {
  ...
  NSNumber* sharedAssets = [NSNumber numberWithDouble:[self.assets doubleValue] + [fiancee.assets doubleValue] - 50000.0];;
...
- (void)divorce {
  ...
  self.assets = [NSNumber numberWithDouble:[self.assets doubleValue] / 2.0];
  self.spouse.assets = [NSNumber numberWithDouble:[self.spouse.assets doubleValue] / 2.0];
