/*************************************************************************
 *  File name   : main.m
 *  Description : Main module for Assignment 3 (Assertion) program.
 *
...
int main(int argc, const char * argv[])
{
	...
	*/
	...
	NSLog(@"STEP 2)");
	//[AnnaNielsen addChild:HansJensen];	// Assertion Exception: "You are not allowed to add one of your own parents!"
	//[MetteLarsen addChild:nil];			// Assertion Exception: "You must specify a citizen!"
	...
	NSLog(@"STEP 4)");
	//[HansJensen marry:AnnaNielsen];		// Assertion Exception: "Not a legal marriage. Invalid spouse!"
	//[AnnaNielsen marry:HansJensen];		// Assertion Exception: "Not a legal marriage. Invalid spouse!" 
	//[AnnaNielsen marry:AnnaNielsen];		// Assertion Exception: "Not a legal marriage. Invalid spouse!"
	//[MetteLarsen marry:AnnaNielsen];		// Assertion Exception: "Not a legal marriage. Invalid spouse!"
	//[EmilOlsen marry:SimonHansen];		// Assertion Exception: "Not a legal marriage. Invalid spouse!"
	//[EmilOlsen marry:MiaNielsen];			// Assertion Exception: "Not a legal marriage. Invalid spouse!"
	//[EmilOlsen marry:nil];				// Assertion Exception: "You must specify a citizen!"
	...
	NSLog(@"STEP 6)");
	//[MiaNielsen divorce:HansJensen];		// Assertion Exception: "You are single and therefore unable to divorce this person!"
	//[EmilOlsen divorce:MetteLarsen];		// Assertion Exception: "You are single and therefore unable to divorce this person!"
	//[MartinJensen divorce:nil];			// Assertion Exception: "Divorce failed!"
	//[MartinJensen divorce:MartinJensen];	// NSLOG: "The divorce is not possible!" &  Assertion Exception: "Divorce failed!"
	[MartinJensen divorce:MetteLarsen];		// NSLOG: "The divorce is not possible!";
	...
	*/	
	...
	NSLog(@"STEP 3)");
	//[JensKristensen setButler:ChristineMadsen];	// Assertion Exception: "You are not allowed to have a Noble Butler!"
	//[JensKristensen setButler:JensKristensen];	// Assertion Exception: "You are not allowed to have a Noble Butler!"
	//[AmandaAndersen setButler:nil];				// Assertion Exception: "You must specify a citizen!"
	...
	[AnnaJensen marryNoble:JanAndersen];			// NSLOG: "No marriage. You don't have a Butler!"
	...
	NSLog(@"STEP 7)");
	//[ChristineMadsen divorce:JanAndersen];		// Assertion Exception: "You are single and therefore unable to divorce this person!"
