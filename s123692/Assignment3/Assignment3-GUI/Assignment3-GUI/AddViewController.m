...
- (void)viewDidLoad
{
    ...
    // Init
    self.citizen = [[Citizen alloc] initWithName:@"" andSex:(Sex)nil andAge:(int)nil];
//    _citizen.name = @" ";
//    _citizen.sex = (Sex)nil;
//    _citizen.age = (int)nil;
    self.citizen.spouse = [[Citizen alloc] init];
    self.citizen.spouse.name = @"";
	
    NSArray *keys = [NSArray arrayWithObjects:@"Name", @"Sex", @"Age", @"Spouse", nil];
